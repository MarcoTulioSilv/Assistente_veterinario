...
const runtimeUrl = process.env['DATABASE_URL_REPORTING_APP'];

if (!runtimeUrl) {
  throw new Error(
    'DATABASE_URL_REPORTING_APP ausente. O runtime precisa conectar como ' +
 ...
 *   return withTenant(ctx.tenantId, (tx) => tx.financialRecord.findMany());
 */
